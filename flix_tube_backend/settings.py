...
SECRET_KEY = 'django-insecure-3a&@njau_$^_y41qcf*ysa--t^9xz&$=7ajf&x)qc%vvd7(5*_'
...
MIDDLEWARE = [
    ...
    'flix_tube_backend.middleware.CustomCookieMiddleware',
]
...
#rq worker for loading videos in background
RQ_QUEUES = {
    'default': {
        'HOST': 'localhost',
        'PORT': 6379,
